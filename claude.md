...
### v2.5.0 (2026-09-22) ← 最新
- APP_VERSION を v2.5.0 に更新
- マニュアル更新（表紙バージョン・JP/EN 対象バージョン・JP/EN 更新履歴 v2.5.0追加・Ear Mode制約の説明を新仕様に修正）・PDF 再生成
- exe ビルド・morokoshi250.zip リリース
- git tag v2.5.0
